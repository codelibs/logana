...
flags.DEFINE_integer("group_size", 1, "Group size.")
...
def main(_) -> None:
    ...
    config: TfRankingModelConfig = TfRankingModelConfig(
    ...
    ranker, result = run_train(config)
    export_model_path: str = save_model(ranker, config)
